...
urlpatterns = [
    ...
    path('djangopasswordreset/',django_auth_view.PasswordResetView.as_view(),name='password_reset'),
    path('djangopasswordresetdone/',django_auth_view.PasswordResetDoneView.as_view(),name='password_reset_done'),
    path('djangopasswordresetconfirm/<uidb64>/<token>/', django_auth_view.PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
    path('djangopasswordresetcomplete/', django_auth_view.PasswordResetCompleteView.as_view(), name='password_reset_complete'),
